...
<div class="container">
 ...
 <div class="row">
  ...
  <div style="height: 20px">
   <h1>글자 조작</h1>
   <h3></h3>
   <img src="../main/m1.jpg"width="200" height="300">
   <img src="../main/m2.jpg"width="200" height="300">
   <img src="../main/m3.jpg"width="200" height="300">
   <div style="height:20px"></div>
   <div class="row">
    <h1>select태그 이용</h1>
    <table class="table">
