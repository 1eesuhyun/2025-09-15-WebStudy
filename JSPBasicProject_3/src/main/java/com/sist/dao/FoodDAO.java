...
public class FoodDAO {
	...
	static
	{
		...
		try
		{
			 ...
			 *  prarameterType="String">
			 *  SELECT CEIL(COUNT(*)/20.0)
			 *  FROM menupan_food
			 *  WHERE type LIKT '%'||#{type}||'%'
			 *  </select>
			 *  
			 *  map
			 */
    ...
    SELECT + INDEX_ASC(menupan_food menuf_fno_pkfno,poster,name,address,type
	/*FROM menupan_food
	 ...
	 */
	public static int foodTotalaPage(String type)
	{
