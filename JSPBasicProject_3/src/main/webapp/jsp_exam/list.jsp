...
final jakarta.servlet.http.HttpServletResponse responsere
...
int totalpage=FoodDAO.foodTotalaPage(type);
...
<script type="text/javascript">
 $(function(){
	 ...
	 // 일반 자바 스크립트 = window.onload=function(){}
...
<body>
 ...
 <table class="table" width="800">
  <tr>
   <td>
    <input type=text size=20 id="keyword" placeholder="검색어 입력"></td>
  </tr>
  </table>
