    ...
    <%--
                ...
                메모리에 out.write("<html>")
                       ------------------
                        ...
                        ---------
                         | 브라우저에 읽기 => 화면에 출력
         - 실제 클래스 변환
           public class test__jsp extends HttpJspBase
           {
            ------------------------------------
             멤버변수 / 메소드 등록
             <%!
     ...
     3장)
        ...
        Java Resource
         ...
         webapp => 폴더단위 : 웹파일(jsp,html,css,js,image파일)
           | WEB-INF
              | lib => 라이브러리(.jar)
           ...
           ** page 지시자 : jsp파일에 대한 정보
              사용법
               ...
               => contentType*** : 브라우저에 전송 방법
                  ...
                  3) json => text/paian;charset=utf-8***
               => errorPage
               => isErrorPage***
               => buffer
               => import***
