 ...
 <div class="container">
  <div class="row">
   ...
   <table class="table">
    ...
    <tr>
    <td>response</td>
    <td>서버에서 클라이언트로 응답할 때 사용
     <br>
     HTML/COOKIE => 한개 JSP안에서 두 가지를 동시에 보낼 수 없다
     <br>
    ...
    <li>sendRedirect(): 서버에서 화면이동 = GET</li>
    ...
    <td>웹 애플리케이션 전체에 대한 정보를 저장 or 공유<br>
     전역적 데이터 저장소
    </td>
    <ul>
     <li>getInitParameter():web.xml에 등록된 데이터 읽기</li>
     <li>getRealPath():실제 톰갯이 읽는 메모리 공간</li>
    </ul>
    <td></td>
    <td></td>
    </tr>
