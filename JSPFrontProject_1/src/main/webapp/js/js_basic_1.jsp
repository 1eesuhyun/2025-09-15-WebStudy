...
<%--
   JavaScript
      ...
      --------------------------------
      자바 스크립트
      1) 정의 : 웹 브라우저에서 동작하는 스크립트언어
                                  -------- 단순한 언어
      2) 용도 : 동적 웹 페이지 제작, 서버 개발(NodeJS)
               앱 개발(React Native)
      3) 실행 환경 : 브라우저
         ...
         변수 : 1개의 데이터를 저장하는 메모리 공간
               ...
               ** 단점
               ...
               let a:string='10' => TypeScript
                   ---------
               => 자료형(데이터형)
                  기본형 : number,string,boolean,null,undifined,bigint
           ...
           자바 스크립트 =============== 자바 ============ 오라클
              ...
              ------------------------------------------- 
                              ...
                              연결 불가능
             = 사용법
               외부 자바 스크립트 : 여러개에 파일에서 공통으로 사용
                     => 자바 스크립트 파일 생성(.jsp)
                        = .js  . jsx  . ts  .tsx
               <srcipt type="text/javascript" src="파일명">
               내부 자바 스크립트 : 한 개의 파일에서 사용
               <head>
                <script>
                  => 설정
                </script>
               </head>
               인라인 자바 스크립트 : 한 개 태안에서 사용
               <input type="button"
  ...
  */
  ...
  window.onload=function(){
	   ...
	   */
	   ...
	   /*
	      출력
	      consloe.log() : console에 출력 => 개발자 도구
