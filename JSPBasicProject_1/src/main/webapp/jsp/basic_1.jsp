      ...
      JSP : Java Server Page
       ...
       -----
        Servlet => Server + let
                   ...
                   => HTML을 쉽게 작업이 가능하게 만든 코드
                      -----------------------------
                      JSP : 자바 / HTML 분리
          => JSP의 단점 : 보안에 취약 => 파일을 그래돌 전송
          => 보안 / 소스 노출없이 : 서블릿
          => 화면 UI : JSP
             -------------------------- MVC
          ...
          => JSP파일을 만드는 이유 : PHP / ASP / CGI
             => 동적 페이지(HTML은 정적페이지) -> 출력 데이터 변경 불가
                | 출력 데이터 변경
          => JSP
             ...
             => 1. 웹 동작
                ...
                Client Server => C/S
                  |      |
                 요청    응답
                 ex) 검색 => 요청값은 검색어 / 검색에  대한 데이터베이스 값
                            --------------------------------------
                             | 출력
             ...
             4. 데이터베이스 : 오라클 / MySQL / MariaDB
                ...
                3. 서버에서 해당 파일을 찾는다
                   ...
                   | 메모리에 저장(출력버퍼)
                4. 메모리에 저장된 HTML을 브라우저에서 한 줄씩 번역
